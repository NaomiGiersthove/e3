<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit'])) {
        ...
        $db->edit_reserveringen($reservering_id, $klant_id, $naam, $telefoon, $email, $tafel, $datum, $tijd, $aantal, $status, $datum_toegevoegd, $allergieen, $opmerkingen);
    }
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add'])) {
        ...
        $db->add_reservering($naam, $telefoon, $email, $tafel, $datum, $tijd, $aantal, $allergieen, $opmerkingen);
    }
...
<?php }else{
	echo "<h2>Er zijn momenteel geen reserveringen vandaag</h2>";
} ?>
