<?php 
    ...
    $drinken = $db->select(" SELECT menuitems.ID, menuitems.Code, menuitems.Naam, menuitems.Prijs ,gerechtsoorten.ID AS soort_ID ,gerechtcategorieen.Naam AS soort, gerechtsoorten.Naam AS soort_naam FROM menuitems 
...
<body>
	...
	<table>
		...
		<tbody><h1>Drinken aanpassen of verwijderen</h1>
